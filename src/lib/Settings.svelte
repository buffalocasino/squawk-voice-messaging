<script>
  import { myPeerId, connectionStatus } from '../stores.js'
...
<div class="p-4 space-y-4">
  ...
  <div class="bg-gray-900 rounded-2xl p-4 space-y-3">
    ...
    <div class="flex items-center justify-between">
      ...
      <button onclick={() => copyId($myPeerId)} class="flex items-center gap-1.5 text-xs text-brand-400 hover:text-brand-300 transition-colors">
  ...
  <div class="bg-gray-900 rounded-2xl p-4 space-y-3">
    ...
    <div class="flex items-center justify-between">
      ...
      <span class="text-xs text-brand-400 font-medium bg-brand-500/10 px-2 py-1 rounded-full">Olm (Matrix)</span>
    </div>
    <div class="flex items-center justify-between">
  ...
  <div class="bg-gray-900 rounded-2xl p-4 space-y-3">
    ...
    <div class="flex items-center justify-between">
      ...
      <span class="text-xs text-brand-400 font-medium bg-brand-500/10 px-2 py-1 rounded-full">On</span>
    </div>
  ...
  <div class="bg-gray-900 rounded-2xl p-4 space-y-3">
    ...
    <button
      ...
      class="w-full py-2.5 bg-brand-600 hover:bg-brand-500 rounded-xl text-sm font-semibold transition-colors active:scale-[0.98]"
    >
  ...
  <!-- Refresh -->
  <button onclick={refresh} class="w-full py-2 bg-gray-800 hover:bg-gray-700 rounded-xl text-xs text-gray-400 transition-colors">
    Refresh Status
  </button>
</div>